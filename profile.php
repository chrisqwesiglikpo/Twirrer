...
<section class="mainSectionContainer">
                ...
                <div class="profile-modal-content">
                           ...
                           <div class="modal-header-profile">
                                       ...
                                       <div class="skip-for-now" id="skip-profile-pic">Skip for now</div>
                            </div>
                        ...
                        <div class="upload-coverprofilePic-modal-step">
                           <div class="cover-modal-header-profile">
                                        <div class="profile-edit-back profile-go-back">
                                        ...
                                        <div class="coverphoto-site-logo-wrapper">
                                            <i class="fa fa-twitter"></i>
                                        </div>
                                       <div class="skip-for-now" id="skip-cover-photo">Skip for now</div>
                            </div>
                                    <div class="cover-modal-body-profile">
                                         <div class="cover-modal-photo">
                                            <h3>Pick a header</h2>
                                            <p>People who visit your profile will see it. Show your style.</p>
                                         </div>
                                         <!-- <input type="file" id="filePhoto" class="displayFileInput" name="filePhoto"> -->
                                         <div class="cover-modal-body-profile-wrapper">
                                                <!-- <div class="cover-image-profile-container">
                                                  <img src="frontend/assets/images/defaultProfilePic.png" alt="" width="40px">
                                                </div> -->
                                                <div class="cover-image-btn-upload-icon">
                                                   <label for="fileCoverPhoto">
                                                   <svg viewBox="0 0 24 24" class="camera-cover-icon"><g><path d="M19.708 22H4.292C3.028 22 2 20.972 2 19.708V7.375C2 6.11 3.028 5.083 4.292 5.083h2.146C7.633 3.17 9.722 2 12 2c2.277 0 4.367 1.17 5.562 3.083h2.146C20.972 5.083 22 6.11 22 7.375v12.333C22 20.972 20.972 22 19.708 22zM4.292 6.583c-.437 0-.792.355-.792.792v12.333c0 .437.355.792.792.792h15.416c.437 0 .792-.355.792-.792V7.375c0-.437-.355-.792-.792-.792h-2.45c-.317.05-.632-.095-.782-.382-.88-1.665-2.594-2.7-4.476-2.7-1.883 0-3.598 1.035-4.476 2.702-.16.302-.502.46-.833.38H4.293z"></path><path d="M12 8.167c-2.68 0-4.86 2.18-4.86 4.86s2.18 4.86 4.86 4.86 4.86-2.18 4.86-4.86-2.18-4.86-4.86-4.86zm2 5.583h-1.25V15c0 .414-.336.75-.75.75s-.75-.336-.75-.75v-1.25H10c-.414 0-.75-.336-.75-.75s.336-.75.75-.75h1.25V11c0-.414.336-.75.75-.75s.75.336.75.75v1.25H14c.414 0 .75.336.75.75s-.336.75-.75.75z"></path></g></svg>
                                                   </label>
                                                   <input type="file" id="fileCoverPhoto" class="fileInputPhoto" name="filePhoto">
                                                </div>
                                         </div>
