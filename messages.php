...
<section class="mainSectionContainer">
    ...
    <div class="resultsContainer resultsContainer__msg" aria-label="Timeline:Inbox" data-chat="<?php echo $chatId; ?>">
      <?php   $loadFromPost->displayChatUsers($user_id,$chatId,7); ?>
    </div>
</section>
</main>
<script src="<?php echo url_for('frontend/assets/js/partsScroll.js'); ?>"></script>
