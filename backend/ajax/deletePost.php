<?php
 ...
 if(isset($_POST['postId']) && !empty($_POST['postId'])){
  $userId=h($_POST['postedBy']);
  $postId=(int)h($_POST['postId']);

  echo '<div class="del-post-wrapper">
...
if(isset($_POST['p_id']) && !empty($_POST['p_id'])){
  $userId=h($_POST['postedBy']);
  $postId=(int)h($_POST['p_id']);

  echo '<div class="d-wrapper">
  ...
  <div class="d-content" id="pin-content">
      ...
      <span class="p-text">Pin to your profile</span>
  </div>
</div>';
