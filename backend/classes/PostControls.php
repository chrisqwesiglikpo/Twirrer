...
class PostControls{
    ...
    public function createControls($postId,$postedBy,$user_id){
        $replyButton=$this->createReplyButton($postId,$postedBy);
        $retweetButton=$this->createRetweetButton($postId,$postedBy);
    ...
    private function createReplyButton($postId,$postedBy){
       return '<div class="postButtonContainer">
       <button id="replyModal" data-post="'.$postId.'" data-user="'.$postedBy.'">
    ...
    private function createRetweetButton($postId,$postedBy){
       return '<div class="postButtonContainer">
          <button data-post="'.$postId.'" data-user="'.$postedBy.'">
    ...
    private function createlikeButton($postId,$postedBy,$user_id){
       ...
       if($post->wasLikedBy($user_id,$postId)){
         $imageSrc="<i class='fa fa-heart'></i>";
       }
       return ' <div class="postButtonContainer">
        '.ButtonProvider::createPostButton($text,$imageSrc,$action,$class,$postId,$postedBy).'
       </div>';
    }
